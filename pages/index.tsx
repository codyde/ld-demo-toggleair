  ...
  return (
    <>
      ...
      <main className={`flex h-screen bg-white flex-col`}>
        <div className="grid xl:flex xl:py-32 mb-8 bg-ldgray w-full shadow-2xl items-center mx-auto text-white">
          <div className="flex mx-auto">
            <div className="w-1/2  flex flex-col items-center place-content-center">
              <div className="flex items-center">
                ...
                >
                  <p className="text-6xl  px-4 py-2 ">{fromLocation}</p>
                </button>
                <MoveHorizontalIcon
                  strokeWidth={1}
                  width={100}
                ...
                >
                  <p className="text-6xl px-4   py-2 ">{toLocation}</p>
                </button>
                      ...
                      <PopoverTrigger asChild>
                        <button>
                          {startDate ? (
                            ...
                            <div className="flex flex-col items-center">
                              <p className="text-4xl mb-4">Depart</p>
                      ...
                      <PopoverTrigger asChild>
                        <button>
                          {returnDate ? (
                            ...
                            <div className="flex flex-col items-center">
                            <p className="text-4xl mb-4">Return</p>
                            <CalendarIcon size={30} />
                            </div>
                          )}
                        </button>
            ...
            <div className="w-1/2 place-content-center mx-auto ">
              <div className="grid mx-auto w-1/ text-left">
        ...
        <div className="relative flex justify-center gap-x-4 mb-14 z-0">
          <Card className="flex w-[320px] h-auto border-0 relative flex-col justify-center items-center animate-fade-in grid-rows-2 bg-gray-50 z-0">
            ...
            <CardTitle className="flex justify-center p-2 py-4">
              <p className="font-bold text-3xl text-gray-700 text-center">
